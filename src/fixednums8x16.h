 ...
 *
 * This font also contains a few special characters that are nice for certain
 * applications like clocks, signed values or decimal point values.
 *
 * Font is really 16 tall but this file is set to indicate 15 to allow it to
 * line up with the lcd page size. It works as the the bottom row in the glyph
 * is whitespace anyway. The rendering code normally inserts a pad pixel so this
 * size allows additional rows on 32 and 64 tall glcd displays.
 *
 */
